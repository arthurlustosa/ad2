---
title: "Predição/nUtilizando Ridge e Lasso"
...
toPlot3 <- data.frame(Rsquared = c(linear_rmse, linear_rmse_v, ridge_rmse, ridge_rmse_v, lasso_rmse, lasso_rmse_v),
                        tipo = c("treino", "validacao", "treino", "validacao", "treino", "validacao"),
                        modelo = c("LM","LM","RIDGE", "RIDGE","LASSO", "LASSO"))

ggplot(data=toPlot3, aes(x = modelo, y = Rsquared, fill = tipo)) +
