...
p1.p2.train[p1.p2.train=="NaN"] = NA 

p1.p2.train$media <- rowMeans(p1.p2.train, na.rm = T) %>%
  mutate()



for (i in 1:nrow(p1.p2.train)){
  if (is.na(p1.p2.train[i,7])){
...
p1.p2.train$C2[p1.p2.train$C2=="NaN"] = rowMeans(p1.p2.train, na.rm = T)
p1.p2.train <- na.omit(p1.p2.train)
p1.p2.train <- rowMeans(p1.p2.train, na.rm = T)
# DADOS TESTE
